...
public class TransformerService implements TransformerServiceMBean {
     ...
     * {@inheritDoc}
     * 
     * @see me.chenzhi.retransformString.heliosapm.shorthandexamples.TransformerServiceMBean#transformClass(java.lang.String,
     ...
     * @param classLoader
     *            The classloader the class was loaded from
     * @param methodName
     *            The method name to instrument
     * @param methodSignature
     *            The method signature to match
     */
